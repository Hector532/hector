...
sudo_users = {SUDO,bot_id,1896308467}   
...
if tonumber(user_id) == tonumber(1896308467) then  
var = true  
...
local UserName = (data.username_ or "Nn_crl")
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'قناه السورس️️', url="t.me/Nn_crl"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
usertext = '\n ✿ العضو ↝ ['..result.title_..'](t.me/'..(username or 'Nn_crl')..')'
status  = '\n ✿ تم ترقيته مطور'
...
usertext = '\n ✿ العضو ↝ ['..data.first_name_..'](t.me/'..(data.username_ or 'Nn_crl')..')'
status  = '\n ✿ تم ترقيته مطور'
...
if DRAGON1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ✿ العضو ↝ ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'Nn_crl')..') \n ✿ '..DRAGON1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
send(msg.chat_id_,0," ✿ العضو : {["..data.first_name_.."](T.ME/Nn_crl)}\n ✿ ["..DRAGON_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, " ✿ عذرا ↝ {["..data.first_name_.."](T.ME/Nn_crl)}\n ✿ عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
✿مرحب بيك في سورس ايفيل الاعظم✿
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'H è Ꮯ Т ❍ R ',url="t.me/Uu_krl"}},
{{text = '𓆩𝙨𝙤𝙪𝙧𝙘𝙚𓆪', url="t.me/Nn_crl"}},
{{text = '𓆩𝗧𝘄𝗮𝘀𝗼𝗹𓆪', url="t.me/Uu_krl25BOT"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,' ✿ بواسطه ↝ ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'Nn_crl')..') \n ✿ تـم قفـل الدردشه ')
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ✿ بواسطه ↝ ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'Nn_crl')..') \n ✿ تـم قفـل التاك بالكتم ')
end,nil)   
...
if result.sender_user_id_ == tonumber(1896308467) then
...
if DevSoFi(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/HECTORa2/eivel/main/getfile.json")
if res == 200 then
local Get_info, res = pcall(JSON.decode,Get_Files);
vardump(res.plugins_)
if Get_info then
local TextS = "\n ✿ اهلا بك في متجر ملفات ايفيل\n ✿ ملفات السورس ↓\n•━━━━━━━𝐸𝑉𝐼𝐿 ━━━━━━•ٴ\n\n"
local TextE = "\n•━━━━━━━𝐸𝑉𝐼𝐿 ━━━━━━•ٴ\n ✿ علامة تعني { ✔️ } ملف مفعل\n ✿ علامة تعني { ✖ } ملف معطل\n ✿ قناة سورس ايفيل ↓\n".." ✿ [اضغط هنا لدخول](t.me/Nn_crl) \n"
local NumFile = 0
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n ✿ لعضو ↝ ['..data.first_name_..'](t.me/'..(data.username_ or 'Nn_crl')..')'
status  = '\n ✿ تم تنزيله من المميزين'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n ✿ العضو ↝ '..userid..''
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ✿ العضــو ↝ ['..data.first_name_..'](t.me/'..(data.username_ or 'Nn_crl')..')'
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n ✿ العضو ↝ ['..result.title_..'](t.me/'..(text1[3] or 'Nn_crl')..')'..'\n ✿ تم رفعه '..text1[2]..'')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
database:set(bot_id.."Nn_crl:insta_bot"..msg.chat_id_,"close")
end
if text == "تفعيل الانستا" and Manager(msg) then
send(msg.chat_id_, msg.id_,'⌯ تم تفعيل الانستا')
database:set(bot_id.."Nn_crl:insta_bot"..msg.chat_id_,"open")
end
if text and text:match("^معلومات (.*)$") and database:get(bot_id.."Nn_crl:insta_bot"..msg.chat_id_) == "open" then
...
database:set(bot_id.."Nn_crl:Tag:Admins:"..msg.chat_id_,true)
send(msg.chat_id_, msg.id_,"✿تم تفعيل تاك المشرفين")
end
if text and text == "تعطيل تاك المشرفين" and Manager(msg) then 
database:del(bot_id.."Nn_crl:Tag:Admins:"..msg.chat_id_)
...
if database:get(bot_id.."Nn_crl:Tag:Admins:"..msg.chat_id_) then 
tdcli_function ({ID = "GetChannelMembers",channel_id_ = msg.chat_id_:gsub("-100",""),filter_ = {ID = "ChannelMembersAdministrators"},offset_ = 0,limit_ = 100},function(arg,data)
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(extra,data) 
local rtp = Rutba(result.sender_user_id_,msg.chat_id_)
local username = ' ['..data.first_name_..'](t.me/'..(data.username_ or 'Nn_crl')..')'
local iduser = result.sender_user_id_
...
{
{text = '𝑠𝑜𝑢𝑟𝑐𝑒 𝑒𝑖𝑣𝑒𝑙', url="t.me/Nn_crl"},
